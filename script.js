...
function setup() { // setup function 
  ...
  player1 = new Player(width/2, height * 7/8); // player constructor (basket) and placement 
...
function play() { // play function 
  ...
  player1.x = mouseX -300;// basket movement horozontally on the screen 
 //player1.y = mouseY; 
  ...
  if(dropTimer.isFinished()){
    ...
    for(let i = 0; i < mushrooms.length; i ++){
      ...
      let d = dist(mushrooms[i].x, player1.x); // collison 
      if(d < 50){
